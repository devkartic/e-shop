...
import Create from "@/Pages/Admin/General/Products/Create.vue";
import Edit from "@/Pages/Admin/General/Products/Edit.vue";
import Delete from "@/Pages/Admin/General/Products/Delete.vue";
...
<template>
    ...
    <AuthenticatedLayout>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr v-for="product in props.products.data" :key="product.id">
                                <td class="px-3 py-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="text-sm font-medium text-gray-900" v-text="product.name"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-3 py-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">
                                                <span v-if="Boolean(product.status)" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">Active</span>
                                                <span v-if="!Boolean(product.status)" class="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/20">Active</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-3 py-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="text-sm font-medium text-gray-900"
                                                 v-text="product.order_number"></div>
                                        </div>
                                    </div>
                                </td>
        ...
        <!--    Pagination-->
        <Pagination :links="props.products.links" class="mt-6"/>
    </AuthenticatedLayout>
